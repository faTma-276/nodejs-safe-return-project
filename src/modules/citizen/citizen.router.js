...
import { addCitizen,  deleteCitizen, getAllCitizens, getOneCitizen, updatecitizen } from './citizen.controller.js'
import { protectedAdminRouter } from '../admin/admin.controller.js'

const citizenRouter=express.Router()
citizenRouter.route('/')
   .post(protectedAdminRouter,fileUpload(fileValidation.image).single('image'),allowedTo('admin'),validate(schema.addCitizenSchema),addCitizen)
